...
For null behavior on unique constraints, see [@@unique — Null Behavior](composite-unique#null-behavior-on-optional-fields) and [@unique — Null Behavior](/schema/decorators/indexes/unique#null-behavior-on-optional-fields).
