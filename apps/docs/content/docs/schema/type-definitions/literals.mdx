...
:::tip
Literals also support `extends` for inheritance (distinct from inline composition). The child literal inherits all variants from the parent and can add new ones. See the [Extends](/schema/extends/) page for details.
:::
