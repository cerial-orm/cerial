...
:::tip
Optional tuple fields produce `field?: TupleName` — there is no `| null` in the type. Tuples are either present or absent (NONE), same as [optional object fields](/objects/object-fields-on-models).
:::
