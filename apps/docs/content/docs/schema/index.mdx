...
- **Comments** use `#`, `//`, or `/* */` — see [Comments](/cerial/schema/comments/) for all three styles
...
<CardGrid>
  <LinkCard title="Field Types" description="All built-in types — String, Int, Float, Bool, Date, Record, Uuid, Duration, Decimal, and more." href="/cerial/schema/field-types/" />
  <LinkCard title="Arrays" description="Array syntax, default behavior, the @set decorator, and supported element types." href="/cerial/schema/field-types/arrays/" />
  <LinkCard title="Optional Fields" description="Optional fields, nullable fields, and the NONE vs null distinction." href="/cerial/schema/optional-fields/" />
  <LinkCard title="Comments" description="Three comment styles — hash, double-slash, and block comments." href="/cerial/schema/comments/" />
  <LinkCard title="Cross-File References" description="Split schemas across files — recursive scanning, forward references, and shared scopes." href="/cerial/schema/cross-file-references/" />
</CardGrid>
