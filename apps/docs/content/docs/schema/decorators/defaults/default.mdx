...
This distinction matters because SurrealDB treats NONE (field absent) and null (field present with null value) differently. See [Optional Fields](/cerial/schema/optional-fields/) for details on NONE vs null semantics.
