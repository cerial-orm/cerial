...
See [Optional Fields](/schema/optional-fields/) for full details on NONE vs null semantics.
...
You can always override with an explicit [`@onDelete(Action)`](/schema/decorators/relations/on-delete/).
