...
SurrealDB requires `COMPUTED` fields to be top-level — they cannot be defined on embedded object sub-fields or tuple elements. Use [`@createdAt`](/schema/decorators/datetime/created-at/) or [`@updatedAt`](/schema/decorators/datetime/updated-at/) for timestamp fields within objects.
:::
...
| [`@createdAt`](/schema/decorators/datetime/created-at/) | Yes | Yes | No | Record creation timestamp |
| [`@updatedAt`](/schema/decorators/datetime/updated-at/) | Yes | Yes | Yes | Last modification timestamp |
