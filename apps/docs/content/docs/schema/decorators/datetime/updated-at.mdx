...
| --- | --- | --- | --- | --- | --- |
| [`@createdAt`](/schema/decorators/datetime/created-at/) | Yes | Yes | No | Yes | `Date` only |
| `@updatedAt` | Yes | Yes | Yes | Yes | `Date` only |
| [`@now`](/schema/decorators/datetime/now/) | No | N/A (computed) | N/A (computed) | No | `Date` only |
| [`@defaultAlways(value)`](/schema/decorators/defaults/default-always/) | Yes | Yes | Yes | Yes | Any |
