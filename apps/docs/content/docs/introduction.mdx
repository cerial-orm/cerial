...
Cerial is built for TypeScript developers using [Bun](https://bun.sh/) who want a structured, type-safe layer on top of SurrealDB. Whether you're building a REST API, a real-time app, or a CLI tool backed by SurrealDB, Cerial keeps your data layer predictable and your types honest.
