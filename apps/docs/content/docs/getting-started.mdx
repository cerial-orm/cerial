...
:::note
Cerial works with **Node.js 20+**, **Bun 1+**, and **Deno**. You need one of these runtimes installed, plus a running **[SurrealDB](https://surrealdb.com/)** instance.

- **[Node.js](https://nodejs.org/)** 20 or later — install from [nodejs.org](https://nodejs.org/)
- **[Bun](https://bun.sh/)** 1.0 or later — install with `curl -fsSL https://bun.sh/install | bash`
- **[Deno](https://deno.com/)** — install from [deno.com](https://deno.com/)

Install SurrealDB from [surrealdb.com/install](https://surrealdb.com/install) and start it with `surreal start`.
:::
