...
6. **Query Records**
   ...
   :::note
   `findOne` returns `T | null` — always check for null. `findMany` returns `T[]` (an empty array if nothing matches). Use `findAll()` as a shorthand for `findMany()` with no options when you want every record.
   :::
...
<CardGrid>
  <LinkCard title="Schema" description="Full schema syntax — field types, decorators, arrays, optionals, and more." href="/cerial/schema/" />
  <LinkCard title="Relations" description="1:1, 1:N, and N:N relations with nested creates, connects, and cascade deletes." href="/cerial/relations/" />
  <LinkCard title="Queries" description="All query methods — findOne, findMany, upsert, count, exists, and transactions." href="/cerial/queries/" />
  <LinkCard title="Filtering" description="Comparison, string, array, logical, and nested filter operators." href="/cerial/filtering/" />
  <LinkCard title="Objects & Tuples" description="Embedded object types and fixed-length tuple types with sub-field select." href="/cerial/objects/" />
  <LinkCard title="Type System" description="CerialId, NONE vs null, generated types, and dynamic return types." href="/cerial/types/" />
</CardGrid>
