...
- [Defining Objects](/objects/defining-objects) — Schema syntax for declaring object types
- [Object Fields on Models](/objects/object-fields-on-models) — Using objects as required, optional, or array fields
- [Primitive Arrays in Objects](/objects/primitive-arrays-in-objects) — Using primitive array fields inside objects
