...
See [Nested Create](/cerial/relations/nested-create/) for full details.
...
See [Connect & Disconnect](/cerial/relations/connect-disconnect/) for full details.
...
The `@key` value must match between the forward and reverse sides of each pair. See [Multiple Relations](/cerial/relations/multi-relation/) and [Self-Referential](/cerial/relations/self-referential/) for detailed usage.
...
See [Delete Behavior](/cerial/relations/on-delete/) for all `@onDelete` options including `Cascade`, `SetNull`, `SetNone`, `Restrict`, and `NoAction`.

## Sections

- [One-to-One](/cerial/relations/one-to-one/) — Single record on each side
- [One-to-Many](/cerial/relations/one-to-many/) — One parent, many children
- [Many-to-Many](/cerial/relations/many-to-many/) — Bidirectional arrays with atomic sync
- [Self-Referential](/cerial/relations/self-referential/) — Models that reference themselves
- [Single-Sided Relations](/cerial/relations/single-sided/) — Forward-only relations with no reverse
- [Multiple Relations](/cerial/relations/multi-relation/) — Multiple relations between the same models using `@key`
- [Nested Create](/cerial/relations/nested-create/) — Creating related records inline
- [Connect & Disconnect](/cerial/relations/connect-disconnect/) — Linking and unlinking existing records
- [Delete Behavior](/cerial/relations/on-delete/) — Cascade, SetNull, SetNone, Restrict, and NoAction
